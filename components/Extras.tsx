    ...
    <div className='my-10 mt-[60px] w-[90%] mx-[5%]'>
        <div>
            ...
            <div className='w-[80%] min-h-[300px] rounded-sm mx-[10%] grid grid-cols-2 gap-10 my-4'>
                <div className='w-full h-full bg-lightFg dark:bg-darkFg dark:bg-darkFg rounded-md'></div>
                <div className='flex flex-col items-start gap-4 justify-center'>
                    ...
                    <button className='p-4 transition-all text-white duration-500 hover:-translate-y-2 bg-mainColor rounded-lg text-sm hover:text-white'>Connect with Fellow Readers</button>
                </div>
            ...
            <div className='w-[80%] min-h-[300px] rounded-sm mx-[10%] grid grid-cols-2 gap-10 my-10 mt-[100px]'>
                <div className='flex flex-col items-start gap-4 justify-center'>
                    ...
                    <button className='p-4 transition-all text-white duration-500 hover:-translate-y-2 bg-mainColor rounded-lg text-sm hover:text-white'>let's get reading💪</button>
                </div>
