...
function Profileactions() {
  return (
    <div className="w-[80%] min-h-[100px] p-4 bg-lightFg dark:bg-darkFg rounded-md mt-2 mx-auto">
      ...
      <p className="text-mainColor text-[12px] my-1">free tier ends on: 12.12.2025</p>
      <div className="grid grid-cols-6 mt-2  w-full h-[60px]">
        ...
        <button className="w-[150px]  bg-red-600 text-white animate-pulse text-sm flex items-center justify-center gap-2 rounded-md transition-all hover:border-mainColor hover:border h-[40px]">
